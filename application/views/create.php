        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="form1">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <input type="email" class="form-control" placeholder="Email address" id="email" name="email" aria-label="Email address">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Mobile number" id="mobile" name="mobile" aria-label="Mobile">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-2">
